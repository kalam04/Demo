...
<html>
    ...
    <body>
         <div class="container">
              <br />
              <br />
              <h2 align="center">Group Data Add</h2>

              <div class="form-group">
                   <form action="{{url('class-time-table')}}" method="POST" >
                      @csrf
                        ...
                        <div class="table-responsive">
                             <table class="table table-bordered" id="dynamic_field">
                              <thead>
                                  ...
                                  <tr>
                                       <td>
                                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name=subject[] required>
                                      ...
                                      <td>
                                          <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name=teacher[] required>
                                      ...
                                      <td><input type="time" name="time_form[]" placeholder="Time form" class="form-control name_list" required/></td>
                                      <td><input type="time" name="time_to[]" placeholder="Time To" class="form-control name_list" required/></td>
                                       <td><input type="text" name="room_no[]" placeholder="Room No" class="form-control name_list" required/></td>
